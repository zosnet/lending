      ...
      <div class="separ">
            ...
            <span>
              ...
              {{$t('m.borrow.borrowRate')}}
                ...
                <div style="flex:1"></div>
                <el-button type="primary" v-if="tableDataInterestShow && isUpdateInterest()" @click="tableDataInterestShow=!tableDataInterestShow">
  ...
  export default {
    ...
    methods: {
      ...
      getConfig () {
        ...
        this.typeKeyUint = this.$t('m.invest.periodmode' + typeKey.repayment_period_uint)
