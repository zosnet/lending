  ...
  <div>
    <div class="w margin-b10 secondary">
      <div class="nav-secondary">
        <router-link to="/borrow/borrows" class="dHMsll gTHKWe">
          <a @click="changePage(1)" class="dHMsll gTHKWe" >
            <div class="rsdjt gTHKWe Navbar__link" :class="{lineBottom:choosePage===1}">
              <!--我要借款-->
              <div class="bgdPDV">{{$t('m.borrow.title')}}</div>
            </div>
          </a>
        </router-link>
        <router-link to="/borrow/borrowingList" class="dHMsll gTHKWe">
        ...
        <router-link to="/borrow/borrowsuccess" class="dHMsll gTHKWe">
        ...
        <router-link to="/borrow/badloanList" class="dHMsll gTHKWe">
        ...
        <router-link to="/borrow/historyloanList" class="dHMsll gTHKWe">
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      // 通过路由改变导航文字样式
      getPage () {
        if (this.$route.path === '/borrow/borrows') {
          this.changePage(1)
        } else if (this.$route.path === '/borrow/borrowingList' ||
        this.$route.path === '/borrow/borrowingdetail') {
          this.changePage(2)
        } else if (this.$route.path === '/borrow/borrowsuccess' ||
        this.$route.path === '/borrow/borrowsuccessdetail') {
          this.changePage(3)
        } else if (this.$route.path === '/borrow/badloanList' ||
        this.$route.path === '/borrow/badloandetail') {
          this.changePage(4)
        } else if (this.$route.path === '/borrow/historyloanList' ||
          this.$route.path === '/borrow/historyloandetail') {
          this.changePage(5)
        }
      }
    },
