    ...
    <div v-loading="subloading" :element-loading-text="$t('m.params.submit')">
      ...
      <div class="layout">
        <el-card class="box-card box-card-left">
          ...
          <div class="dy_main dy_main_left">
            <div class="dy_left_item" style="margin-bottom:77px;">
              ...
              <el-row>
                <el-col :span="6" class="title_info">{{$t('m.lockasseted.ratestr')}}:</el-col>
          ...
          <div class="dy_btn" @click="createitem(1)">{{$t('m.params.create_fixed')}}</div>
        </el-card >
        <div class="dy_right">
          ...
          <div class="dy_main">
            <el-row>
              ...
              <el-col :span="16" class="num_info">
                <span class="symbol_unit">{{locksum.locktoken[1].total.symbol}}</span>
                {{locksum.locktoken[1].total.amount | formatLegalCurrency3('', locksum.locktoken[1].total.precision)}}
              </el-col>
            </el-row>
            <el-row>
              <el-col :span="6" class="title_info">{{$t('m.lockasseted.allinterest')}}:</el-col>
              <el-col :span="16" class="num_info" v-if="locksum.locktoken[1].interest.length < 1">0</el-col>
              <el-col :span="16" class="num_info" v-else>
                <span v-for="(item,index) in locksum.locktoken[1].interest"  :key="index">
            ...
            <el-row>
              ...
              <el-col :span="16" class="num_info">{{locksum.locktoken[1].count}}</el-col>
            </el-row>
          </div>
          </el-card>
        ...
        <el-tabs v-model="activeTabName" @tab-click="handleClick" class="margin-t10 margin-lr10">
          ...
          <el-table
            ...
            <el-table-column width="50"  align="center" :label="$t('m.lockasseted.lockperiod')">
              <template slot-scope="scope">
                <span> {{scope.row.period.toString()}}{{$t('m.months')}}</span>
              </template>
            </el-table-column>
            <el-table-column width="100"  align="center" :label="$t('m.lockasseted.lockmode')">
              <template slot-scope="scope">
                <span> {{$t('m.lockasseted.lockmode'  + scope.row.autolock)}}</span>
              </template>
            </el-table-column>
            <el-table-column width="100"  align="center" :label="$t('m.lockasseted.interestrate')">
              <template slot-scope="scope">
            ...
            <el-table-column width="165"  align="center" :label="$t('m.lockasseted.creattime')">
             ...
             <el-table-column width="165"  align="center" :label="$t('m.lockasseted.exceptime')">
              <template slot-scope="scope">
                <span>{{scope.row.except_time}}</span>
              </template>
            </el-table-column>
          <el-table-column  align="center" :label="$t('m.lockasseted.exceptinterest')">
              <template slot-scope="scope">
                {{scope.row.except_interst | formatLegalCurrency3('', scope.row.interestprecision)}}
                <span class="symbol_unit">{{lockobj.interest_name}}</span>
              </template>
            </el-table-column>
          <el-table-column width="220" align="center" :label="$t('m.orderList.operation')">
              <template slot-scope="scope"  class="flex-h">
                ...
                <el-button type="text" @click="operator(5, scope.row)">{{$t('m.lockasseted.modify')}}</el-button>
          ...
          <el-table-column width="50" align="center" :label="$t('m.orderList.operation')">
              <template slot-scope="scope"  class="flex-h">
                <el-button  type="text" @click="operator(0, scope.row)">{{$t('m.lockasseted.detail')}}</el-button>
              </template>
            </el-table-column>
      ...
      >
       <div class="layout_model" style="min-height: 10vw;">
        <div class="dy_main">
          ...
          <el-row> <el-col :span="6" class="title_info">{{$t('m.lockasseted.lockperiod')}}:</el-col>
            <el-col :span="16" class="num_info">{{ruleForm.period}} {{this.$t('m.months')}} </el-col></el-row>
          <el-row> <el-col :span="6" class="title_info">{{$t('m.lockasseted.lockmode')}}:</el-col>
            <el-col :span="16" class="num_info">{{lockmodelist[ruleForm.mode - 1].label}}</el-col></el-row>
          <el-row>
            <el-col :span="6" class="title_info">{{$t('m.drawDialog.available')}}:</el-col>
            <el-col :span="16" class="num_info">
              <span class="symbol_unit">{{selectSymbol.symbol}}</span>
          ...
          <el-row v-if='feed!==1.0'>
            <el-col :span="6" class="title_info">{{$t('m.lockasseted.feed')}}:</el-col>
            <el-col :span="16" class="num_info">
              {{this.feed}}
  ...
  export default {
    ...
    data () {
      var vlockamount = (rule, value, callback) => {
        ...
        } else if (vari > Number(this.available)) {
          callback(new Error(this.$t('m.borrow.useLess') + (variZos - this.available)))
